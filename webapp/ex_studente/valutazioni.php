...
$qry = "SELECT __studente, __appello, __insegnamento, __nome_insegnamento, __data, __nome_docente, __voto, __valida, __media FROM unimia.get_valutazioni_per_ex_studente($1)";
