...
<head>
  ...
  <title>Disiscriviti appello - SuperUnimia</title>
</head>
  ...
  <div class="container is-max-desktop">
    ...
    <form class="box p-6" action="" method="post">
      ...
      <span class="icon-text">
        ...
        <h1 class="title mt-2">Disiscriviti appello</h1>
      </span>
      ...
      <div class="field">
        <p class="control has-icons-left">
          <input class="input" type="text" value="<?php echo $row["__ultimo_voto"] == "" ? "Mai sostenuto" : $row["__ultimo_voto"] ?>" required disabled>
          <span class="icon is-small is-left">
