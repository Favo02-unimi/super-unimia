...
$title = "Iscriviti appello";
$subtitle = "Iscriviti all'appello selezionato.";

$class = "is-link";
$help = "Iscrivendosi ad un appello di un insegnamento già superato verrà considerato in carriera il voto più recente.";
...
$inputs = array(
  ...
  array(
    ...
    "readonly"=>"readonly",
    "icon"=>"fa-marker",
    "help"=>"Questo voto (se presente) verrà sovrascritto dal risultato di questo appello."
  )
);
