...
<head>
  ...
  <title>Modifica docente - SuperUnimia</title>
</head>
  ...
  <div class="container is-max-desktop">
    ...
    ?>
      ...
      <span class="icon-text">
        ...
        <h1 class="title mt-2">Modifica Docente</h1>
      </span>
      ...
      <div class="icon-text mt-5">
        ...
        <span>Modificando manualmente nome, cognome o email, potrebbero generarsi inconsistenze tra email ed effetivo nome e cognome del docente.</span>
      </div>

      <div class="field mt-5">
        <p class="control">
          <input type="submit" name="submit" value="Modifica docente" class="button is-link is-fullwidth is-medium">
        </p>
      </div>
