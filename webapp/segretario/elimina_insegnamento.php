...
<head>
  ...
  <title>Elimina insegnamento - SuperUnimia</title>
</head>
  ...
  <div class="container is-max-desktop">
    ...
    ?>
      ...
      <span class="icon-text">
        ...
        <h1 class="title mt-2">Elimina insegnamento</h1>
      </span>
      ...
      <div class="field mt-5">
        ...
        <p class="help is-danger">È possibile cancellare un insegnamento solo in caso non sia mai utilizzato (non abbia appelli associati). Utilizzare l'archivio per dismettere.</p>
      </div>
